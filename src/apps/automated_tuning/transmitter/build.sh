...
# src/components/ (invn-soniclib, soniclib_esp32_bsp, icu_post) and the automated-tuning shared
# headers under ../include/ resolve.
#
...
app_rel=${script_dir#"$src_dir"/}                         # apps/automated_tuning/transmitter
